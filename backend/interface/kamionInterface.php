    ...
    public function newKamion($data) {  
        try {
            ...
            $query = "INSERT INTO kamion 
                      (admin,rendszam, potkocsi, muszaki_lejarat, adr_lejarat, taograf_illesztes, emelohatfal_vizsga, porolto_lejarat, porolto_lejarat_2, kot_biztositas, kot_biz_dij, kot_biz_utem, kaszko_biztositas, kaszko_dij, kaszko_fizetesi_utem) 
                      VALUES (:admin,:rendszam, :potkocsi, :muszaki_lejarat, :adr_lejarat, :taograf_illesztes, :emelohatfal_vizsga, :porolto_lejarat, :porolto_lejarat_2, :kot_biztositas, :kot_biz_dij, :kot_biz_utem, :kaszko_biztositas, :kaszko_dij, :kaszko_fizetesi_utem)";
