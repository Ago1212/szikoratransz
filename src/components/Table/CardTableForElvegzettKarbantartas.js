...
const CardTableForElvegzettKarbantartas = ({ kamion_id, refresh, onRefresh }) => {
...
CardTableForElvegzettKarbantartas.propTypes = {
  kamion_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  refresh: PropTypes.bool,
  onRefresh: PropTypes.func,
};

export default CardTableForElvegzettKarbantartas;
