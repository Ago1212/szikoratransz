...
const CardTableForFurgonTervezettKarbantartasok = ({ furgon_id, refresh, onRefresh }) => {
  ...
  const handleSave = async (e) => {
    ...
    const result = await fetchAction("updateFurgonKarbantartas", {
      admin: user.ceg_id,
...
CardTableForFurgonTervezettKarbantartasok.propTypes = {
  furgon_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
  refresh: PropTypes.bool,
  onRefresh: PropTypes.func,
};

export default CardTableForFurgonTervezettKarbantartasok;
