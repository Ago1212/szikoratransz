      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="w-full">
          <div className="mb-6 rounded-3xl bg-white p-6 shadow-soft ring-1 ring-ink-100">
            ...
            <select
              className="w-full rounded-xl border border-ink-100 bg-sand-50 px-4 py-3 text-sm text-brand-900 transition-colors duration-200 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-300"
